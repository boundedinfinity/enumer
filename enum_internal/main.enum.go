...
func pred(s string) func(MyEnum) bool {
	return func(v MyEnum) bool {
		return string(v) == s
	}
}
...
func Parse(v string) (MyEnum, error) {
...
func Is(s string) bool {
	return slices.ContainsFn(All, func(v MyEnum) bool {
		return string(v) == s
	})
}
...
func (t MyEnum) MarshalYAML() (interface{}, error) {
	return string(t), nil
}

func (t *MyEnum) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
